...
ControlSelect(ControlHwnd, HWND = "") 
 ;SendMessage requires the HWND of the target Window
...
FileMove(SourcePattern = "", DestPattern = "", Overwrite = "-Overwrite") 
 ; FileMove(OldName, NewName, "Overwrite")
...
Out: None
*/
FileWrite(Text = "", Filename = "", Prompt = "-Prompt", Encoding = "") 
 ;Custom
...
WinShow(HWND) 
 ;WinShow(WinGetID(GuiTitle)
WinWait(HWND, Timeout = "") 
 ;WinWait(WinGetID(GuiTitle), 5)
WinWaitActive(HWND, Timeout = "") 
 ;WinWaitActive(WinGetID(GuiTitle), 5)
WinWaitNotActive(HWND, Timeout = "") 
 ;WinWaitNotActive(WinGetID(GuiTitle), 5)
WinWaitClose(HWND)
